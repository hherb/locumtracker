...
class ReceiptScreenTest {
    ...
    fun testEmptyState_showsMessage() {
        ...
        composeRule.onNodeWithText("No Receipts Yet").assertIsDisplayed()
        composeRule.onNodeWithText("Tap + to add your first receipt").assertIsDisplayed()
    }
    ...
    fun testAddButton_exists() {
        ...
        composeRule.onNodeWithContentDescription("Add Receipt").assertExists()
    }
}
